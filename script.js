...
// Function to compare time blocks with current time 
function testTime() {
    // Add time1 9AM
    time1 = moment().startOf('day').add(9, "hours");
    // Adjusts current time to hour
    currentTime = currentTime.startOf("hour");
    // Add time1 if/else
...
testTime();
// Loops input to retreive item from local storage
...
// Event listener save to local storage
